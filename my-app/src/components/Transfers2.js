// Description: This page includes for labels, forms an containers for transfers to occur
...
<Container>
  ...
  <FormGroup>
                ...
                <Input type="select" name="accType" id="accType" placeholder="Account type">
                    <option>Student Account</option> //account options for optimal use of client user interface
