 ...
 <Container className="text-center">
   <div className="profile-update-wrapper">
          ...
          <form className="contact-form" id="contactForm" name="contact-form" action="sendemail.php" method="POST">
            <div className="row"> //row length decided on for user experience
              <div className="col-md-4">
                <div className="form-group">
                  <FormGroup className="text-center">
                    <InputGroup>
                      <InputGroup.Addon>@</InputGroup.Addon>
                      <FormControl type="text" placeholder="Your username" /> //for username
                    </InputGroup>
                  </FormGroup>
                  <br />
                  <br />
              ...
              <div className=" col-md-6 map"> // For easy access to best user experience a map in any application always makes clients feel at home
